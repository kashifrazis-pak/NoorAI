      ...
      {answer || loading ? (
        <div className="flex-1 max-w-2xl mx-auto w-full px-4 py-8 space-y-6">
          ...
          <div className="sticky bottom-6">
            <AskPanel onAnswer={setAnswer} onLoading={setLoading} onError={setError} compact/>
          </div>
        </div>
      ) : (
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-10">
          ...
          <div className="w-full max-w-2xl animate-slide-up">
            <AskPanel onAnswer={setAnswer} onLoading={setLoading} onError={setError}/>
          </div>
            ...
            {[
              ...
              <button key={label}
                className="flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium
                           ...
                           hover:bg-sage-50 hover:border-sage-300 hover:text-sage-800 transition-all">
